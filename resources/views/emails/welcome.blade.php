...
<table class="nl-container"
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                        ...
                                        <div style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
                                                    Pioneer in the field of clone app development.</p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                            ...
                                            <div style="font-size:12px;line-height:14px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                    <span style="font-size: 28px; line-height: 33px;"><strong><span
                                                                    style="line-height: 33px; font-size: 28px;">Hello {{$user->first_name}},</span></strong></span><br><span
                                                            style="font-size: 28px; line-height: 33px;">Registration completed</span>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center; text-transform: uppercase;">
                                                    With {{ config('constants.site_title', 'Tranxit')  }}, you have
                                                    entered a part of a <br> world that gives you the best of services
                                            ...
                                            <tr>
                                                <td style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:37pt; v-text-anchor:middle; width:106pt;"
                                        ...
                                        <div style="color: #ffffff; background-color: #F9B419; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 142px; width: 62px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 40px; padding-bottom: 5px; padding-left: 40px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none;">
                                            <a style="text-decoration: none;color: #fff;" href="{{ url('/') }}">
                                                <span style="font-size:12px;line-height:24px;"><span
                                                            style="font-size: 20px; line-height: 32px;"><strong><span
                                                                    style="line-height: 32px;">Go to Site</span></strong></span></span></a>
                                        </div>
            ...
            <div style="background-color:transparent;">
                <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #F9B419;"
                     class="block-grid ">
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#F9B419;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="background-color:transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width: 600px;">
                                        <tr class="layout-full-width" style="background-color:#F9B419;"><![endif]-->
                                            ...
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <span style="font-size: 24px; line-height: 28px;"><strong><span
                                                                    style="line-height: 28px; font-size: 24px;">Download this app now</span></strong></span>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#FFFFFF;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <strong><span
                                                                style="font-size: 20px; line-height: 24px;">User App</span></strong>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="right" class="img-container right fixedwidth "
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr style="line-height:0px;line-height:0px;">
                                                <td style="padding-right: 5px; padding-left: 5px;" align="right">
                                        <![endif]-->
                                        <div style="line-height:5px;font-size:1px">&#160;</div>
                                        <a href="{{config('constants.store_link_ios_user','#')}}"> <img
                                                    class="right fixedwidth" align="right" border="0"
                                                    src="{{$message->embed(public_path().'/asset/mail-img/apple.png')}}""
                                            alt="Image" title="Image" style="outline: none;text-decoration:
                                            none;-ms-interpolation-mode: bicubic;clear: both;display: block
                                            !important;border: 0;height: auto;float: none;width: 100%;max-width: 180px"
                                            width="180"></a>
                                        <div style="line-height:5px;font-size:1px">&#160;</div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="left" class="img-container left fixedwidth "
                                        ...
                                        <![endif]-->
                                        <div style="line-height:5px;font-size:1px">&#160;</div>
                                        <a href="{{config('constants.store_link_android_user','#')}}"> <img
                                                    class="left fixedwidth" align="left" border="0"
                                                    src="{{$message->embed(public_path().'/asset/mail-img/android.png')}}"
                                                    alt="Image" title="Image"
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#FFFFFF;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <span style="font-size: 18px; line-height: 21px;"><strong>Provider App</strong></span>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="right" class="img-container right fixedwidth "
                                        ...
                                        <![endif]-->
                                        <div style="line-height:5px;font-size:1px">&#160;</div>
                                        <a href="{{config('constants.store_link_ios_provider','#')}}"> <img
                                                    class="right fixedwidth" align="right" border="0"
                                                    src="{{$message->embed(public_path().'/asset/mail-img/apple.png')}}"
                                                    alt="Image" title="Image"
                                                    style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 180px"
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="left" class="img-container left fixedwidth "
                                        ...
                                        <![endif]-->
                                        <div style="line-height:5px;font-size:1px">&#160;</div>
                                        <a href="{{config('constants.store_link_android_provider','#')}}"> <img
                                                    class="left fixedwidth" align="left" border="0"
                                                    src="{{$message->embed(public_path().'/asset/mail-img/android.png')}}"
                                                    alt="Image" title="Image"
                                                    style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 180px"
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#f9b419;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
                                            <div style="font-size:12px;line-height:14px;color:#f9b419;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;">
                                                <a href="tel:+13153143250"><p
                                                        ...
                                                        <span style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;"><span
                                                                    style="font-size: 12px; line-height: 14px; color: #f9b419;">Tel:</span>{{ config('constants.contact_number', '+9197911 01817')  }}</span>
                                                    </p></a></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div class="">
                                        ...
                                        <![endif]-->
                                        <div style="color:#f9b419;;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
                                            <div style="font-size:12px;line-height:14px;text-align:center;color:#f9b419;;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                                                <a href="mailto:info@tranxit.co"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center;    color: #f9b419;
 ">Email :<span style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;"><span
                                                                    style="font-size: 12px; line-height: 14px;"></span><span
                                                                    style="font-size: 12px; line-height: 14px;">{{ config('constants.contact_email', 'info@tranxit.co')  }}</span></span>
                                                    </p></a></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
