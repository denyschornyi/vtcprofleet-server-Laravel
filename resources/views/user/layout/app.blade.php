                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="{{url('/')}}"><img
                                    src="{{ config('constants.site_logo', asset('logo-black.png')) }}"></a>
                    </div>
                            ...
                            <div class="">
                                ...
                                <div class="col-md-6">
                                    <div class="">
                                        ...
                                        <div class="col-md-6">
                                            <a target="_blank"
                                               href="{{config('constants.store_link_android_user','#')}}">
                                ...
                                <div class="col-md-6">
                                    <div class="">
                                        <div class="col-md-6">
                                            <a target="_blank"
                                               href="{{config('constants.store_link_ios_provider','#')}}">
                                                <img src="{{asset('asset/img/provider-appstore.png')}}">
                                            </a>
                                        </div>
                                        <div class="col-md-6">
                                            <a target="_blank"
                                               href="{{config('constants.store_link_android_provider','#')}}">
                ...
                <div class="row center">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="socil-media">
                            <ul>
                                <li><a target="_blank" href="{{config('constants.store_facebook_link','#')}}"><i
                                                class="fa fa-3x fa-facebook"></i></a></li>
                                <li><a target="_blank" href="{{config('constants.store_twitter_link','#')}}"><i
                                                class="fa fa-3x fa-twitter"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ config('constants.map_key') }}&libraries=places&callback=initMap"></script>
