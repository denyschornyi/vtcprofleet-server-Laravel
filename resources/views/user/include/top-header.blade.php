<div class="row message-tbar">
        ...
        <div class="msg-icons">
            <div class="msg-icon-img">
                ...
                if($fleet_id == '0')
                {
                    ...
                    $notifications = App\Notifications::where([['notify_type','!=','provider'],['status','active'],['fleet_id',$fleet_id]])
                            ->where(function ($query) use ($fleet_id){
                                return $query->where('fleet_id','=',$fleet_id);
                            })->orderBy('created_at' , 'desc')
                            ->get();
                }
    ...
    <div class="col-lg-3 col-md-4 msg-rt">
        <div class="msr-wrapc">
            <div class="msg-welcome"><span>WELCOME</span><br>
                @if (Auth::user()->user_type =='FLEET_COMPANY' || Auth::user()->user_type =='COMPANY')
