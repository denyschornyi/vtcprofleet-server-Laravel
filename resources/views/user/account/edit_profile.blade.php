        ...
        <div class="row no-margin edit-pro">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="first_name" required placeholder="@lang('user.profile.first_name')" value="{{Auth::user()->first_name}}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="@lang('admin.custom.user_login')">
                </div>
                <div class="form-group col-md-6">
                    <label>@lang('user.profile.last_name')</label>
                    <input type="text" class="form-control" name="last_name" required placeholder="@lang('user.profile.last_name')" value="{{Auth::user()->last_name}}" data-validation-allowing=" -" data-validation-error-msg="@lang('admin.custom.user_login')">
                </div>
                    ...
                    <div class="prof-sub-col col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <div id="phone_number_container" style="display: none;">
                                ...
                                <input type="text" class="form-control col-sm-2"  name="country_code" value="" placeholder="+33" >
                                </div>
