...
<div class="col-md-9">
    <div class="dash-content">
        ...
        <div class="row no-margin payment">
            <div class="col-md-12">
                <h5 class="btm-border"><strong>@lang('admin.custom.user_promo')</strong> <a href="#" class="sub-right pull-right" data-toggle="modal" data-target="#add-promotion-modal">@lang('user.add_promocode')</a></h5>
                ...
                @empty
                <div class="pay-option">
                    <h6 class="text-center">@lang('admin.custom.user_nopromo')</h6>
                </div>
                @endforelse
            </div>
        </div>
                ...
                <div class="modal-body">
                    <div class="row no-margin" id="card-payment">
                        <div class="form-group col-md-12 col-sm-12">
                            <label>@lang('admin.include.promocodes')</label>
