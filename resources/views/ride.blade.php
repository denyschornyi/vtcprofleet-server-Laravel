        ...
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <p>{{ config('constants.site_title', 'Tranxit')  }} is the smartest way to get around. One tap and a
                        car comes directly to you. Your driver knows exactly where to go. And you can pay with either
                        cash or card.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <div class="title-divider"></div>
                    <p>When you arrive at your destination, either pay with cash or have your card automatically
                        charged. With {{ config('constants.site_title', 'Tranxit') }}, the choice is yours.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 content-block small">
                <div class="box-shadow">
                    ...
                    <div class="title-divider"></div>
                    <p>Rate your driver and provide anonymous feedback about your trip. Your input helps us make every
                        ride a 5-star experience.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 content-block">
                ...
                <form method="post" id="idForm" onsubmit="return">
                    ...
                    <div class="input-group fare-form">
                        <input type="text" class="form-control" placeholder="Enter pickup location" id="origin-input"
                               name="s_address">
                    </div>

                    <div class="input-group fare-form no-border-right">
                        <input type="text" class="form-control" placeholder="Enter drop location" id="destination-input"
                               name="d_address">
        ...
        <div class="container">
            <div class="col-md-6 content-block">
                ...
                <p>Whether riding in the backseat or driving up front, every part of
                    the {{ config('constants.site_title', 'Tranxit') }} experience has been designed around your safety
                    and security.</p>
                <a class="content-more more-btn" href="{{url('login')}}">HOW WE KEEP YOU SAFE <i
                ...
                <div class="col-md-8 col-md-offset-2">
                    <form>
                        <div class="input-group find-form">
                            <input type="text" class="form-control" placeholder="Search" id="mode-selector"
                                   name="s_address1">
            ...
            $("#btnSubmit").click(function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#div2").html("Distance - " + data.distance + " kilometers(s)");
