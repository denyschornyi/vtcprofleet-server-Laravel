        ...
        <div class="col-md-4 offset-md-4 px-3">
            <div class="box b-a-0">
                <div class="p-2 text-xs-center">
                    <h5>@lang('admin.custom.account_loin')</h5>
                </div>
                ...
                <div class="p-2 text-xs-center text-muted">
                    <a class="text-black" href="{{ url('/account/password/reset') }}"><span class="underline">@lang('admin.auth.forgot_your_password')</span></a>
                </div>
            </div>
        </div>
    </div>
