    	...
    	<div class="row row-md">
			<div class="col-lg-3 col-md-6 col-xs-12">
				<div class="box box-block bg-white tile tile-1 mb-2">
					...
					<div class="t-content">
						...
						<span class="text-muted font-90">@lang('admin.custom.account_cancel')</span>
					</div>
				</div>
			</div>
			<div class="col-lg-3 col-md-6 col-xs-12">
			...
			<div class="col-lg-3 col-md-6 col-xs-12">
				<div class="box box-block bg-white tile tile-1 mb-2">
					...
					<div class="t-content">
						<h6 class="text-uppercase mb-1">@lang('admin.custom.account_total')</h6>
						<h1 class="mb-1">{{$cancel_rides}}</h1>
						<i class="fa fa-caret-down text-danger mr-0-5"></i><span>@lang('admin.custom.ffgg') @if($cancel_rides == 0) 0.00 @else {{round($cancel_rides/$rides->count(),2)}}% @endif @lang('admin.custom.fghh')</span>
					</div>
				</div>
			</div>
		</div>
		<div class="row row-md">	
			<div class="col-lg-3 col-md-6 col-xs-12">
				<div class="box box-block bg-white tile tile-1 mb-2">
					<div class="t-icon right"><span class="bg-primary"></span><i class="ti-view-grid"></i></div>
					<div class="t-content">
						<h6 class="text-uppercase mb-1">@lang('admin.custom.account_count')</h6>
			...
			<div class="col-lg-3 col-md-6 col-xs-12">
				<div class="box box-block bg-white tile tile-1 mb-2">
					...
					<div class="t-content">
						<h6 class="text-uppercase mb-1">@lang('admin.custom.account_count_pro')</h6>
