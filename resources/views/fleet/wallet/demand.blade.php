...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            @include('common.date_filter', ['action' => 'fleet.payment_demand'])
            ...
            <table class="table table-striped table-bordered dataTable" id="table-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$pending->company? $pending->company : 'Admin'}} </td>
                       
                        <td>{{ $pending->company?$pending->country_code." ".$pending->mobile : $admin->country_code." ".$admin->mobile }}</td>
