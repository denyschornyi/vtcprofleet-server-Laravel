...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="col-md-12" style="height:50px;color:red;">
            ...
            <a href="{{ route('fleet.dispatch-manager.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> @lang('admin.dispatcher.add_new_dispatcher')</a>
            @endcan
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if(Setting::get('demo_mode', 0) == 1)
						                        <td>+33612345678</td>
                        @else
                        <td>{{ $dispatcher->country_code }}{{ $dispatcher->mobile }}</td>
                        @endif
                        @if(Setting::get('demo_mode', 0) == 1)
                        <td>admin</td>
                        @else
                        ...
                        @endif
                        <td>
                            <form action="{{ route('fleet.dispatch-manager.destroy', $dispatcher->id) }}" method="POST">
                                {{ csrf_field() }}
                                <input type="hidden" name="_method" value="DELETE">
{{--                                @if( Setting::get('demo_mode', 0) == 0 && $index !=0)--}}
                                <a href="{{ route('fleet.dispatch-manager.edit', $dispatcher->id) }}" class="btn btn-info"><i class="fa fa-pencil"></i> @lang('admin.edit')</a>
