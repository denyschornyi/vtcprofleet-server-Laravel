...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('fleet.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                {{csrf_field()}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <select class="form-control" id="calculator" name="calculator" style="padding: 5px;">
                ...
                {{-- set min price --}}
                <div class="form-group row">
                    <label for="fixed" class="col-xs-2 col-form-label">@lang('admin.service.min_price') ({{ currency('') }})</label>
                    <div class="col-xs-5">
                        <input class="form-control min_price" type="number" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" value="{{ $service->min_price }}" name="min_price" required id="min_price" placeholder="0" min="0">
                    </div>
                </div>
