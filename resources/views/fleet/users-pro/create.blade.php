...
<div class="content-area py-1">
	<div class="container-fluid">
		<div class="box box-block bg-white">
			<a href="{{ route('fleet.user-pro.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

			<h5 style="margin-bottom: 2em;">@lang('admin.users.Add_User')</h5>

			<form class="form-horizontal" action="{{route('fleet.user-pro.store')}}" method="POST" enctype="multipart/form-data" role="form" onkeypress="return disableEnterKey(event);">
				{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-12">
						...
						<a href="{{route('fleet.user-pro.index')}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
