    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                @include('common.date_filter', ['action' => 'fleet.payment'])
...
{{--                            <td>@if(!empty($payment->payment->payment_id)){{$payment->payment->payment_id}}@else NA @endif</td>--}}
                            <td>@if(!empty($payment->booking_id)){{$payment->booking_id}}@else NA @endif</td>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('fleet.requests.show', $payment->id) }}" class="dropdown-item">
