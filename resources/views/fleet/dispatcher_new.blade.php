                ...
                <div class="clearfix container" style="margin-top: 50px;">
                    <div class="row chbs-main chbs-booking-form-id-10007 chbs-clear-fix chbs-width-1220"
                        ...
                        <form name="chbs-form">
                            ...
                            <input type="hidden" id = "errorTxt" value=@lang('admin.custom.success')>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var date_require = "{{ trans('admin.custom.date_require') }}";
            ...
            $('#chbs_client_contact_detail_first_name_passenger').on('click change touchstart touch',function () {
            ...
            $('#chbs_client_contact_detail_last_name_passenger').on('click change touchstart touch',function () {
            ...
            $('#chbs_client_contact_detail_email_address_passenger').on('click change touchstart touch',function () {
        ...
        $('#chbs_client_contact_detail_phone_number_passenger').on('click change touchstart touch',function () {
        ...
        $("#booking_submit").click(function () {
            ...
            $.ajax({
                url: '/fleet/submitBookingDataforDispatcher',
                method: 'POST',
                data: data,
    ...
    <script src="{{asset('asset/booking_form/js/jquery.fleet_hauffeurBookingForm.js')}}"></script>
