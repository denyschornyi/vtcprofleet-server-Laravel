...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            @include('common.date_filter', ['action' => 'fleet.payment_request'])
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        {{-- <td>
                            ...
                            <button type="button" class="btn btn-success btn-block transferClass" data-toggle="modal" data-target="#transferModal" data-id="send" data-href="{{route('fleet.payment.approve', $pending->id) }}" data-rid="{{$pending->id}}">@lang('admin.approve')</button>
                            <!-- <a class="btn btn-danger btn-block" href="{{ route('fleet.cancel') }}?id={{$pending->id}}">@lang('admin.cancel')</a> -->

                            <button type="button" class="btn btn-danger btn-block transferClass" data-toggle="modal" data-target="#transferModal" data-id="cancel" data-href="{{ route('fleet.payment.cancel', $pending->id) }}" data-rid="{{$pending->id}}">@lang('admin.cancel')</button>
                            @endif
                        </td> --}}
