    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{route('fleet.send.push')}}" method="POST" role="form"
                      id="create_push">
                    ...
                    <div class="form-group row" id="for_users" style="display: none;">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" name="user_condition"
                                ...
                                <option value="" disabled>@lang('admin.push.Nnoon')</option>
                    ...
                    <div class="form-group row" id="for_providers" style="display: none;">
                        ...
                        <div class="col-xs-5" id="provider_location" style="display: none;">
                            <input type="text" class="form-control" id="search_provider_location"
                                   placeholder="@lang('admin.push.Laion')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            <textarea maxlength="200" class="form-control" rows="3" name="message" required id="message"
                                      placeholder="@lang('admin.push.Essage')"></textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-10">
                            ...
                            <button data-toggle="modal" data-target="#schedule_modal" type="button"
                                    class="btn btn-success">@lang('admin.push.Schedule_Push')</button>
                        </div>
                    </div>
                </form>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        function switch_send(send_value) {
            if (send_value == 'USERS') {
                $('#for_users').show();
                this.switch_user_condition('ACTIVE');
                $('#for_providers').hide();
