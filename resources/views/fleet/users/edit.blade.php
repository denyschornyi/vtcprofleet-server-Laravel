...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('fleet.user.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

			<h5 style="margin-bottom: 2em;">@lang('admin.service.Update_User')</h5>

            <form class="form-horizontal" action="{{route('fleet.user.update', $user->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
...
{{--						<input class="form-control" type="number" value="{{ $user->country_code }}{{ $user->mobile }}" name="mobile" required id="mobile" placeholder="@lang('admin.mobile')">--}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-12">
						...
						<a href="{{route('fleet.user.index')}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
