    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                <a href="{{ route('fleet.notification.create') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> @lang('admin.notification.add')</a>
                ...
                <table class="table table-striped table-bordered dataTable" id="table-2">
                    ...
                    @foreach($notification as $index => $notify)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('fleet.notification.destroy', $notify->id) }}" method="POST">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="_method" value="DELETE">
                                    @if( Setting::get('demo_mode', 0) == 0)
                                    <a href="{{ route('fleet.notification.edit', $notify->id) }}" class="btn btn-info"><i class="fa fa-pencil"></i> @lang('admin.reason.ediis')</a>
