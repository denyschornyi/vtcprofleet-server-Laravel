...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
    	    <a href="{{ route('fleet.notification.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

			<h5 style="margin-bottom: 2em;">@lang('admin.notification.update')</h5>

            <form class="form-horizontal" action="{{route('fleet.notification.update', $notification->id )}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control datetimepicker" autocomplete="off"  type="text" value="{{ \Illuminate\Support\Carbon::parse($notification->expiry_date)->format('d-m-Y H:m') }}" name="expiry_date" required id="expiry_date" placeholder="@lang('admin.notification.notify_expiry')">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('fleet.notification.index')}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
