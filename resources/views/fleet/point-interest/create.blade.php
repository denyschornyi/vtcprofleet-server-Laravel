    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                <a href="{{ route('fleet.pointInterest.index') }}" class="btn btn-default pull-right"><i class="fa fa-angle-left"></i> @lang('admin.back')</a>

                <h5 style="margin-bottom: 2em;">@lang('admin.point.Add_Point_Interest')</h5>

                <form class="form-horizontal" action="{{route('fleet.pointInterest.store')}}" method="POST" role="form" onkeydown="return event.key!=='Enter';">
                    {{ csrf_field() }}
                            ...
                            <div class="new_input_field row" style="width: 100%">
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <div class="row" id="shape_save_area" style="display: none;">
                                        <div class="col-md-4"><input type="text" class="form-control" name="shape_name"
