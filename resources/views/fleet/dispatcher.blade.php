...
<script type="text/javascript" src="{{ asset('asset/js/dispatcher-map-fleet.js') }}"></script>
<script type="text/babel" src="{{ asset('asset/js/dispatcher-fleet.js') }}"></script>
@else
<script type="text/javascript" src="{{ asset('asset/js/dispatcher-map-fleet-fr.js') }}"></script>
<script type="text/babel" src="{{ asset('asset/js/dispatcher-fleet-fr.js') }}"></script>
@endif
