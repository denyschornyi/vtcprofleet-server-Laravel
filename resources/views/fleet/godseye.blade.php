...
<div class="container-fluid">
		<div class="box box-block bg-white">
				<div class="clearfix mb-1">
					...
					<button class="btn btn-default godseye_menu" data-value="STARTED">@lang('admin.heatmap.enrou')</button>
					<button class="btn btn-default godseye_menu" data-value="ARRIVED">@lang('admin.heatmap.Reached')</button>
					<button class="btn btn-default godseye_menu" data-value="PICKEDUP">@lang('admin.heatmap.Journey')</button>
					<button class="btn btn-default godseye_menu" data-value="ACTIVE">@lang('admin.heatmap.Available')</button>
					<button class="btn btn-primary godseye_menu" data-value="ALL">@lang('admin.heatmap.all')</button>

					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<h3 class="provider_title btn-primary">@lang('admin.heatmap.all')</h3>
...
@section('scripts')
	<script src="https://maps.googleapis.com/maps/api/js?key={{Config::get('constants.map_key')}}&libraries=places&language=fr"></script>
	<script>
	...
	if( navigator.geolocation ) {
         navigator.geolocation.getCurrentPosition( success, fail );
          ...
          console.log('@lang('admin.heatmap.sooo')');
          initialize();
    }
	...
	function initialize(latitude = 48.85661400000001, longitude = 2.3522219000000177) {
		...
		function getProviders() {
			...
			$.get("{{ route('fleet.godseye_list') }}/?status="+status, function(data) {
