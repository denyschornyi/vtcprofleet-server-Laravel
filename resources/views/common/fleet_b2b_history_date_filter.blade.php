...
<div class="clearfix" style="margin-top: 15px; margin-bottom: 30px;">
    ...
    <form class="form-horizontal" action= "@if($status == '1') {{route('fleet.b2b.poolhistory',[1,$fleet_id])}}
        @elseif($status == '2') {{route('fleet.b2b.poolhistory',[2,$fleet_id])}} @endif"
          method="GET" enctype="multipart/form-data" role="form">
