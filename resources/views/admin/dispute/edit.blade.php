				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<select name="dispute_type" class="form-control">
							<option value="user" @if($dispute->dispute_type=='user')selected @endif>@lang('admin.dispute.dispute_user')</option>
							<option value="provider" @if($dispute->dispute_type=='provider')selected @endif>@lang('admin.dispute.dispute_provider')</option>
						</select>
					</div>
				</div>
