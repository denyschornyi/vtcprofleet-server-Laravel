    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <a href="{{ route('admin.polygonshape.index') }}" class="btn btn-default pull-right"><i
                            class="fa fa-angle-left"></i> @lang('admin.back')</a>
                <a href="{{ route('admin.polygonshape.edit', $obj->id) }}" class="btn btn-default pull-right">
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-6 col-sm-3 col-md-2">
                                    <a href="{{ route('admin.pointinterest.index') }}" class="btn btn-danger">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
