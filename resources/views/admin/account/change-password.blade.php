    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.password.update')}}" method="POST" role="form">
            	...
            	<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="password" name="old_password" id="old_password" placeholder="@lang('admin.account.Olword')">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="password" name="password" id="password" placeholder="@lang('admin.account.Newas')">
					</div>
				</div>
