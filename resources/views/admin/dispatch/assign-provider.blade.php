            ...
            <nav class="navbar navbar-light bg-white b-a mb-2">
                ...
                <div class="collapse navbar-toggleable-sm" id="process-filters">
                    <ul class="nav navbar-nav dispatcher-nav">
                        <li class="nav-item"><span class="nav-link" href="#">@lang('admin.custom.open')</span></li>
                ...
                <div class="card">
                    ...
                    <div class="items-list">
                        ...
                        <div class="il-item">
                            ...
                            <a class="btn btn-success mt-1" href="/admin/dispatcher/cancel?request_id=651">@lang('admin.custom.assign_provider')</a>
                        </div>
                        <!-- Item Block Ends -->
                        <!-- Item Block Starts -->
                        <div class="il-item">
