...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.update.private_pool',['id'=>$data->id])}}" method="POST" role="form">
            	{{csrf_field()}}
...
<script>
	...
	function getPartnerList()
	{
		...
		$.ajax({
			type:'get',
			url: " {{ route('admin.getPartnerList') }}",
			data : {
				'id' : '{{ $data->id }}'
			},
