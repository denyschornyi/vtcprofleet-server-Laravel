        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row" id="hour_price">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" step="any" value="{{ old('fixed') }}" name="hour"  id="hourly_price" placeholder="Set Hour Price( Only For DISTANCEHOUR )" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-5">
                        <input class="form-control price" type="text" step="any" value="{{ old('fixed') }}" name="fixed" required id="fixed" placeholder="Base Price" min="0">
                    </div>
                    <div class="col-xs-5">
                ...
                <!-- set Min price -->
                <div class="form-group row">
                    <label for="min_price" class="col-xs-12 col-form-label">@lang('admin.service.min_price')</label>
                    <div class="col-xs-5">
                        <input class="form-control min_price" type="number" value="{{ old('min_price') }}" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" name="min_price" required id="min_price" placeholder="0" min="0">
                    </div>
                </div>
