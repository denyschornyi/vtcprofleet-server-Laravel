...
{{--                 <div class="form-group row">--}}
{{--                    <label for="name" class="col-xs-12 col-form-label">@lang('admin.mobile')</label>--}}
{{--                    <div class="col-xs-10">--}}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        ...
                        @foreach($roles as $role)
                            <label>
                                <input type="checkbox" value="{{ $role->id }}" @php if($userRole[0]== $role->id) { echo 'checked'; } @endphp
                                name="roles[]" id="role" style="margin-right: 5px;" />
                                {{ $role->name }}
                            </label>
                            <br/>
                        @endforeach
