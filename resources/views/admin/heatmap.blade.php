...
<div class="container-fluid">
      ...
      <button class="btn btn-primary" onclick="toggleHeatmap(event)">@lang('admin.heatmap.Toggle')</button>
      <button class="btn" onclick="changeGradient(event)">@lang('admin.heatmap.gradient')</button>
      <button class="btn btn-primary" onclick="changeRadius(event)">@lang('admin.heatmap.radius')</button>
      <button class="btn btn-primary" onclick="changeOpacity(event)">@lang('admin.heatmap.opacity')</button>
    </div> <br>
