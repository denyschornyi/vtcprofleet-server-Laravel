...
<table width="100%" style="margin-top:30px;">
    ...
    <tr>
        <td colspan="2">
            ...
            <div style="width:80%;">{{$admin->rcs}}</div>
            <div style="width:80%;">{{$admin->siret}}</div>
            <div style="width:80%;">{{$admin->intracommunautaire}}</div>
        </td>
...
{{--            @endif--}}
    ...
    <tr>
        ...
        <td align="right">
            ...
            <div><span style="font-size:14;">{{$admin->rcs}}</span></div>
            <div><span style="font-size:14;">{{$admin->siret}}</span></div>
            <div><span style="font-size:14;">{{$admin->intracommunautaire}}</span></div>
            </div>
        </td>
    </tr>
</table>
