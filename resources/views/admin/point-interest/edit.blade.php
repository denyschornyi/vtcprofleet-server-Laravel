    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            <div class="box box-block bg-white">
                ...
                <form class="form-horizontal" action="{{route('admin.pointinterest.update',$point_interest->id)}}"
                      method="POST" role="form" onsubmit="return validateGeofence();">
                    {{ csrf_field() }}
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td style="padding: 15px 30px;">
                                <input class="form-control" type="text" value="{{ $point_interest->rule_name }}"
                                       name="type" required style="width: 60%;"
                    ...
                    <div class="form-group row">
                        <input id="lat" name="lat" type="hidden"
                               value="{{json_decode($point_interest->start_coordinate)->lat}}">
                        <input id="lng" name="lng" type="hidden"
                               value="{{json_decode($point_interest->start_coordinate)->lng}}">

                        <input id="lat_dest" name="lat_dest" type="hidden"
                               value="{{json_decode($point_interest->dest_coordinate)->lat}}">
                        <input id="lng_dest" name="lng_dest" type="hidden"
                               value="{{json_decode($point_interest->dest_coordinate)->lng}}">
                        <input id="bound" name="bound" type="hidden"
                               value="({{json_decode($point_interest->start_coordinate)->lat}},{{json_decode($point_interest->start_coordinate)->lng}})">
                        <input id="bound1" name="bound1" type="hidden"
                               value="({{json_decode($point_interest->dest_coordinate)->lat}},{{json_decode($point_interest->dest_coordinate)->lng}})">
                    </div>
                            ...
                            <div class="new_input_field row" style="width: 100%">
                                <div class="col-md-6 col-xs-12">
                                    <textarea id="geofence_latlng" name="geofence_latlng"
                                              style="display:none;width: 100%;">{{$point_interest->start_mapdata_origin}}</textarea>
                                    <textarea id="geofence_latlng_dispatcher" name="geofence_latlng_dispatcher"
                                              style="display:none;width: 100%;">{{$point_interest->start_mapdata_latlng}}</textarea>
                                    <h2>Location 1</h2>
                                    ...
                                    <div id="floating-panel">
                                        <button type="button"
                                                class="btn btn-danger mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12"
                                                onclick="removePolygon();"
                                                title="Remove polygon" data-toggle="tooltip"
                                                name="remove_polygon" id="remove_polygon">Remove polygon
                                        </button>
                                        <button type="button"
                                                class="btn btn-success mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12"
                                                title="Save Shape"
                                                data-toggle="tooltip"
                                        ...
                                        <button type="button"
                                                class="btn btn-primary mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12"
                                                onclick="shapeImport();"
                                                title="Import Shape" data-toggle="tooltip"
                                                name="import_shape" id="import_shape">Import Shape
                                        </button>
                                        <button type="button"
                                                class="btn btn-primary mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12"
                                                onclick="poiCategory()"
                                    ...
                                    <div class="row" id="shape_save_area" style="display: none;">
                                        <div class="col-md-4 col-xs-8"><input type="text" class="form-control"
                                                                              name="shape_name"
                                                                              id="shape_name" placeholder="Shape Name">
                                        </div>
                                        <div class="col-md-4 col-xs-4">
                                            <button type="button" class="btn btn-primary mr-15" title="Save"
                                                    data-toggle="tooltip" name="shape_save" id="shape_save"
                                                    onclick="shapeSaveVal(1);">Save
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <textarea id="geofence_other_latlng_dispatcher"
                                              name="geofence_other_latlng_dispatcher"
                                    ...
                                    <div id="floating-panel">
                                        ...
                                        <button type="button"
                                                class="btn btn-primary mr-15 col-lg-3 col-md-5 col-sm-5 col-xs-12"
                                                onclick="shapeImport1();"
                                                title="Import Shape" data-toggle="tooltip"
                                                name="import_shape" id="import_shape">Import Shape
                                        </button>
                                        <button type="button"
                                                class="btn btn-primary mr-15 col-lg-2 col-md-5 col-sm-5 col-xs-12"
                                                onclick="poiCategory1();"
                                                title="POI Category" data-toggle="tooltip"
                                                name="poi_category"
                                                id="poi_category">@lang('admin.poi.poi_category')</button>
                                    </div>
                                    <div class="row" id="shape_save_area_1" style="display: none;">
                                        ...
                                        <div class="col-md-4 col-xs-4">
                                            <button type="button" class="btn btn-primary mr-15" title="Save"
                                                    data-toggle="tooltip" name="shape_save" id="shape_save"
                                                    onclick="shapeSaveVal(2);">Save
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row" id="shape_import_area_1" style="display: none;">
                                        <div class="col-md-4 col-xs-8">
                                            <select class="form-control" id="import_shape_val_1"
                                                    name="import_shape_val_1"
                                                    style="padding: 6px;">
                    ...
                    <div class="inside">
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="ignore_surge_pricing_rule" type="checkbox"
                                           ...
                                           @if($point_interest->ignore_surge_price === 1) checked @endif
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="quickcab_geofence_fixed_price_amount" class="col-xs-10 col-form-label">Fixed
                                        Price</label>
                                </th>
                                <td>
                                    <input min="0" step="0.01" value={{$point_interest->price}}  class="medium-text"
                                           id="quickcab_geofence_fixed_price_amount"
                                           name="quickcab_geofence_fixed_price_amount" type="number">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><label><input type="checkbox" id="select_all" style="margin-right: 5px;"/>All
                                                Vehicles</label></li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="quickcab_geofence_direction"
                                        ...
                                        <option value="1" @if($point_interest->direction_state === 1) selected @endif>
                                            Origin =&gt; Destination (One Direction)
                                        </option>
                                        <option value="2" @if($point_interest->direction_state === 2) selected @endif>
                                            Origin &lt;=&gt; Destination (Both Directions)
                                        </option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" id="status" name="status" style="padding: 6px;">
                                        <option value="1"
                                                @if($point_interest->status === 1) selected @endif>@lang('admin.poi.active')</option>
                                        <option value="0"
                                                @if($point_interest->status === 0) selected @endif>@lang('admin.poi.inactive')</option>
                                    </select>
                                </td>
                            </tr>
                            </tbody>
            ...
            if (shape_title === '') {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        lat: lat,
                        lng: lng,
                        geofence_val: geofence_val,
                        title: shape_title,
                        poi_category_val: poi_category_val
                    },
