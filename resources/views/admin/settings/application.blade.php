            ...
            <div class="box box-block bg-white">
                <div class="bd-example bd-example-tabs" role="tabpanel">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="general-tab" data-toggle="tab" href="#general" role="tab"
                               aria-controls="general" aria-expanded="true">@lang('admin.setting.gnera')</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " id="social-tab" data-toggle="tab" href="#social" role="tab"
                               aria-controls="social" aria-expanded="false">@lang('admin.setting.compolnk')</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="col-md-9">
                                    <form class="form-horizontal" action="{{ route('admin.settings.store') }}"
                                                ...
                                                <select class="form-control" id="timezone" name="timezone"
                                                    ...
                                                    @foreach($timezones as $tz)
                                                        <option value="{{$tz['zone']}}"
                                                                @if(Config::get('constants.timezone') == $tz['zone']) selected @endif>{{$tz['diff_from_GMT']}}
                                                            - {{$tz['zone']}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="number"
                                                       value="{{ config('constants.sos_number', '911')  }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.terms_conditions') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <select class="form-control" id="social_login" name="social_login"
                                                        autocomplete="off">
                                                    <option value="1"
                                                            @if(config('constants.social_login', 0) == 1) selected @endif>@lang('admin.Enable')</option>
                                                    <option value="0"
                                                            @if(config('constants.social_login', 0) == 0) selected @endif>@lang('admin.Disable')</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <select name="distance" class="form-control">
                                                    <option value="Kms"
                                                            @if(config('constants.distance') == 'Kms') selected @endif>
                                                        Kms
                                                    </option>
                                                    <option value="Miles"
                                                            @if(config('constants.distance') == 'Miles') selected @endif>
                                                        Miles
                                                    </option>
                                                </select>
                                            </div>
                        ...
                        <div class="tab-pane fade " id="mailconfig" role="tabpanel" aria-labelledby="mailconfig-tab"
                             aria-expanded="false">
                            <div class="form-box row">
                                <div class="col-md-10">
                                    <form class="form-horizontal" action="{{ route('admin.settings.store') }}"
                                        ...
                                        <div class="form-group row" id="mail_request">
                                            ...
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.send_email') == 1) checked
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <select class="form-control" name="mail_driver" required
                                                        id="mail_driver">
                                                    <option value="SMTP"
                                                            @if(config('constants.mail_driver') == 'SMTP') selected @endif>@lang('admin.setting.smtp')</option>
                                                    <option value="MAILGUN"
                                                            @if(config('constants.mail_driver') == 'MAILGUN') selected @endif>@lang('admin.setting.mailgun')</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.mail_host')  }}" name="mail_host"
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.mail_port')  }}" name="mail_port"
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.mail_username')  }}"
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.mail_password')  }}"
                                        ...
                                        <div class="form-group row hidemail">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="text"
                                                       value="{{ config('constants.mail_from_name')  }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <select name="environment" required id="environment"
                                                        class="form-control">
                                                    <option value="development">@lang('admin.setting.devvs')</option>
                                                    <option value="production">@lang('admin.setting.proddds')</option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-10">
                                    <form class="form-horizontal" action="{{ route('admin.settings.store') }}"
                                        ...
                                        <div class="form-group row" id="referral_request">
                                            ...
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.referral') == 1) checked
                                        ...
                                        <div class="form-group row hideref">
                                            ...
                                            <div class="col-xs-9">
                                                <input class="form-control" type="number"
                                                       value="{{ config('constants.referral_count')  }}"
                                        ...
                                        <div class="form-group row">
                                            <label for="stripe_secret_key"
                                                   class="col-xs-3 col-form-label">@lang('admin.setting.Migning')</label>
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.manual_request') == 1) checked
                                        ...
                                        <div class="form-group row" id="broadcast_request">
                                            ...
                                            <div class="col-xs-1">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.broadcast_request') == 1) checked
                                        ...
                                        <div class="form-group row">
                                            <label for="stripe_secret_key"
                                                   class="col-xs-3 col-form-label">@lang('admin.setting.Ritp')</label>
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.ride_otp') == 1) checked
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-8">
                                                <select name="currency" class="form-control" required>
                                                    <option @if(config('constants.currency') == "$") selected
                                                            @endif value="$">US Dollar (USD)
                                                    </option>
                                                    <option @if(config('constants.currency') == "₹") selected
                                                            @endif value="₹"> Indian Rupee (INR)
                                                    </option>
                                                    <option @if(config('constants.currency') == "د.ك") selected
                                                            @endif value="د.ك">Kuwaiti Dinar (KWD)
                                                    </option>
                                                    <option @if(config('constants.currency') == "د.ب") selected
                                                    ...
                                                    <option @if(config('constants.currency') == "CHF") selected
                                                            @endif value="CHF">Swiss Franc (CHF)
                                                    </option>
                                                    <option @if(config('constants.currency') == "ل.د") selected
                                                            @endif value="ل.د">Libyan Dinar (LYD)
                                                    </option>
                                                    <option @if(config('constants.currency') == "B$") selected
                                                            @endif value="B$">Bruneian Dollar (BND)
                                                    </option>
                                                    <option @if(config('constants.currency') == "S$") selected
                                                            @endif value="S$">Singapore Dollar (SGD)
                                                    </option>
                                                    <option @if(config('constants.currency') == "AU$") selected
                                    ...
                                    <form class="form-horizontal" action="{{ route('admin.settings.store') }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-8">
                                                <input class="form-control"
                                                       type="text"
                                                       value="{{ config('constants.twilio_sid', '') }}"
                                                       id="twilio_sid"
                                                       name="twilio_sid"
                                                       placeholder="">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-8">
                                                <input class="form-control"
                                                       type="text"
                                                       value="{{ config('constants.twilio_token', '') }}"
                                                       id="twilio_token"
                                                       name="twilio_token"
                                                       placeholder="">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="twilio_from" class="col-xs-3 col-form-label">TWILIO FROM</label>
                                            <div class="col-xs-8">
                                                <input class="form-control"
                                                       type="text"
                                                       value="{{ config('constants.twilio_from', '') }}"
                                                       id="twilio_from"
                                                       name="twilio_from"
                                        ...
                                        <div class="form-group row" id="sms_to_user">
                                            <label for="sms_to_user" class="col-xs-3 col-form-label"> Send SMS to the
                                                user </label>
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.sms_to_user') == 1) checked
                                        ...
                                        <div class="form-group row" id="sms_to_fleet">
                                            <label for="sms_to_fleet" class="col-xs-3 col-form-label"> Send SMS to the
                                                fleet </label>
                                            <div class="col-xs-9">
                                                <div class="float-xs-left mr-1"><input
                                                            @if(config('constants.sms_to_fleet') == 1) checked
