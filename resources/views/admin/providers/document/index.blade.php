            ...
            @can('provider-services')
                <div class="box box-block bg-white">
                    ...
                    <a href="{{$backurl}}" style="margin-left: 1em;margin-top: -30px"
                       class="btn btn-primary pull-right"><i class="fa fa-arrow-left"></i>@lang('admin.provides.bkk')
                    </a>
                    <div class="row">
                        <div class="col-xs-12">
                            @if($ProviderService->count() > 0)
                                <hr><h6>@lang('admin.provides.bkkfg')</h6>
                        ...
                        <form action="{{ route('admin.provider.document.store', $Provider->id) }}" method="POST">
                            {{ csrf_field() }}
                            <div class="col-xs-3">
                                <select class="form-control input" name="service_type" required style="padding: 5px;">
                            ...
                            <div class="col-xs-3">
                                <input type="text" required name="service_number" class="form-control"
                                       placeholder="@lang('admin.provides.plaque')">
                            </div>
                            <div class="col-xs-3">
                                <input type="text" required name="service_model" class="form-control"
                                       placeholder="@lang('admin.provides.model')">
                            </div>
                            @if( Setting::get('demo_mode', 0) == 0)
                                <div class="col-xs-3">
