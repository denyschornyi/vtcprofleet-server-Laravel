...
class FleetDispatcherResource extends Controller
{
...
//        $this->middleware('permission:dispatcher-delete', ['only' => ['destroy']]);
    ...
    {
        $dispatchers = Admin::where('created_by', '=', 'fleet_dispatcher')->where('fleet_id',\Illuminate\Support\Facades\Auth::guard('fleet')->id())->orderBy('id' , 'asc')->role('DISPATCHER')->get();
        ...
        return view('fleet.dispatcher.index', compact('dispatchers'));
    }
    ...
    {
        return view('fleet.dispatcher.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
			...
			$users['created_by'] = 'fleet_dispatcher';
	        $users['fleet_id'] = Auth::id();
    ...
    public function edit($id)
    {
        try {
            ...
            return view('fleet.dispatcher.edit',compact('dispatcher'));
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('fleet.dispatcher.index')->with('flash_success', trans('admin.dispatcher_msgs.dispatcher_update'));
        }
