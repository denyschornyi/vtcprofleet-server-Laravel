...
Route::post('/requestSMS', 'AuthyController@requestSMS');
Route::post('/verifySMS', 'AuthyController@verifySMS');
...
Route::group(['middleware' => ['auth:api']], function () {
	...
	Route::post('/getServicePOIDisatnceInfo', 'UserApiController@getServicePOIDisatnceInfo');
	...
	// request
	Route::post('/send/request' , 	'UserApiController@send_request'); //old API don't used
