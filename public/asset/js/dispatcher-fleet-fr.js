...
class DispatcherList extends React.Component {
    ...
    getTripsUpdate() {
        $.get('/fleet/dispatcher/trips?type=SEARCHING', function(result) {
...
class DispatcherAssignedList extends React.Component {
    ...
    getTripsUpdate() {
        $.get('/fleet/dispatcher/trips?type=ASSIGNED', function(result) {
            if(result.hasOwnProperty('data')) {
                this.setState({
                    data: result
                });
...
class DispatcherCancelledList extends React.Component {
    ...
    getTripsUpdate() {
        $.get('/fleet/dispatcher/trips?type=CANCELLED', function(result) {
            if(result.hasOwnProperty('data')) {
                this.setState({
                    data: result
                });
...
class DispatcherListItem extends React.Component {
    ...
    handleCancel(trip, event) {
        ...
        location.assign("/fleet/dispatcher/cancel?request_id="+trip.id);
    }
...
class DispatcherRequest extends React.Component {
    ...
    componentDidMount() {
        ...
        $.get('/fleet/service', function(result) {
            this.setState({
                data: result
            });
        }.bind(this));
...
class DispatcherAssignList extends React.Component {
    ...
    componentDidMount() {
        $.get('/fleet/dispatcher/providers', {
